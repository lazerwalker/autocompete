...
var or__25976__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__25976__auto__)){
return or__25976__auto__;
} else {
var or__25976__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__25976__auto____$1)){
return or__25976__auto____$1;
} else {
var or__25976__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__25976__auto____$2)){
return or__25976__auto____$2;
} else {
var or__25976__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__25976__auto____$3)){
...
var n__26891__auto__ = a.length;
var i = (0);
while(true){
if((i < n__26891__auto__)){
var c_27424 = (a[i]);
if((c_27424["cljsIsDirty"]) === true){
(c_27424["forceUpdate"])();
} else {
}
...
var n__26891__auto__ = fs.length;
var i = (0);
while(true){
if((i < n__26891__auto__)){
(fs[i]).call(null);
...
var temp__4661__auto___27427 = (this$["componentQueue"]);
if((temp__4661__auto___27427 == null)){
} else {
var cs_27428 = temp__4661__auto___27427;
(this$["componentQueue"] = null);

reagent.impl.batching.run_queue.call(null,cs_27428);
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__26582__auto__,writer__26583__auto__,opt__26584__auto__){
return cljs.core._write.call(null,writer__26583__auto__,"reagent.impl.batching/RenderQueue");
});
...
//# sourceMappingURL=batching.js.map?rel=1518788501292