...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__26582__auto__,writer__26583__auto__,opt__26584__auto__){
return cljs.core._write.call(null,writer__26583__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__27897 = o;
(G__27897[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__27898__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__27898 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__27899__i = 0, G__27899__a = new Array(arguments.length -  0);
while (G__27899__i < G__27899__a.length) {G__27899__a[G__27899__i] = arguments[G__27899__i + 0]; ++G__27899__i;}
  args = new cljs.core.IndexedSeq(G__27899__a,0);
} 
return G__27898__delegate.call(this,args);};
G__27898.cljs$lang$maxFixedArity = 0;
G__27898.cljs$lang$applyTo = (function (arglist__27900){
var args = cljs.core.seq(arglist__27900);
return G__27898__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__25964__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__25964__auto__){
var and__25964__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__25964__auto____$1){
var and__25964__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__27905 = jsprops;
(G__27905["defaultValue"] = value);

(G__27905["onChange"] = ((function (G__27905,v,value,on_change){
return (function (p1__27903_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__27903_SHARP_);
});})(G__27905,v,value,on_change))
);
...
var vec__27912 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__27912,(0),null);
var id = cljs.core.nth.call(null,vec__27912,(1),null);
var class$ = cljs.core.nth.call(null,vec__27912,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___27917 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___27917 == null)){
} else {
var key_27918 = temp__4661__auto___27917;
...
var G__27920 = (new reagent.impl.template.NativeWrapper());
(G__27920["name"] = c);
...
var len__27051__auto___27926 = arguments.length;
var i__27052__auto___27927 = (0);
while(true){
if((i__27052__auto___27927 < len__27051__auto___27926)){
args__27058__auto__.push((arguments[i__27052__auto___27927]));

var G__27928 = (i__27052__auto___27927 + (1));
i__27052__auto___27927 = G__27928;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27059__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq27924){
var G__27925 = cljs.core.first.call(null,seq27924);
var seq27924__$1 = cljs.core.next.call(null,seq27924);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__27925,seq27924__$1);
});
...
break;
default:
var G__27932 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__27932;
continue;
...
var n__26891__auto___27935 = a.length;
var i_27936 = (0);
while(true){
if((i_27936 < n__26891__auto___27935)){
(a[i_27936] = reagent.impl.template.as_element.call(null,(a[i_27936])));

var G__27937 = (i_27936 + (1));
i_27936 = G__27937;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__26891__auto___27938 = a.length;
var i_27939 = (0);
while(true){
if((i_27939 < n__26891__auto___27938)){
var val_27940 = (a[i_27939]);
if((cljs.core.vector_QMARK_.call(null,val_27940)) && ((reagent.impl.template.key_from_vec.call(null,val_27940) == null))){
(o["no-key"] = true);
} else {
}

(a[i_27939] = reagent.impl.template.as_element.call(null,val_27940));

var G__27941 = (i_27939 + (1));
i_27939 = G__27941;
continue;
} else {
}
...
var ctx = ({});
var vec__27945 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__27945,(0),null);
var derefed = cljs.core.nth.call(null,vec__27945,(1),null);
...
var G__27949 = (cljs.core.count.call(null,argv) - first_child);
switch (G__27949) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__27949){
...
//# sourceMappingURL=template.js.map?rel=1518788505057