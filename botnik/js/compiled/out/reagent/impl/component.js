...
if((i < len)){
var k = (ks[i]);
var G__27673 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__27674 = (i + (1));
m = G__27673;
i = G__27674;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__27678 = c;
var G__27678__$1 = (((G__27678 == null))?null:G__27678.prototype);
if((G__27678__$1 == null)){
return null;
} else {
return (G__27678__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (cljs.core.some_QMARK_.call(null,(function (){var G__27682 = c;
var G__27682__$1 = (((G__27682 == null))?null:G__27682.prototype);
if((G__27682__$1 == null)){
return null;
} else {
return (G__27682__$1["render"]);
}
})()));
});
...
return (function() { 
var G__27686__delegate = function (args){
...
while (G__27687__i < G__27687__a.length) {G__27687__a[G__27687__i] = arguments[G__27687__i + 0]; ++G__27687__i;}
  args = new cljs.core.IndexedSeq(G__27687__a,0);
} 
...
var _STAR_current_component_STAR_27691 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_27691;
}});
...
var G__27695 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__27695) {
...
var or__25976__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__27697_27699 = (c["cljsRatom"]);
if((G__27697_27699 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__27697_27699);
}
...
if(cljs.core.truth_((function (){var and__25964__auto__ = wrap;
...
if(((1) === cljs.core.count.call(null,renders_27702))){
} else {
...
if(cljs.core.ifn_QMARK_.call(null,render_fun_27703)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun_27703))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__25976__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__25976__auto__)){
return or__25976__auto__;
} else {
...
var render_fun__$1 = (function (){var or__25976__auto__ = render_fun;
if(cljs.core.truth_(or__25976__auto__)){
return or__25976__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__25976__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__25976__auto__)){
return or__25976__auto__;
} else {
...
var name__$1 = (function (){var G__27701 = name;
switch (G__27701) {
case "":
...
var G__27706 = o;
(G__27706[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__27712 = (function (){var or__25976__auto__ = (function (){var G__27714 = c;
if((G__27714 == null)){
return null;
} else {
return (G__27714["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__25976__auto__)){
return or__25976__auto__;
...
return (G__27712["_currentElement"]);
}
})();
var name = (function (){var G__27715 = elem;
var G__27715__$1 = (((G__27715 == null))?null:(G__27715["type"]));
if((G__27715__$1 == null)){
return null;
} else {
return (G__27715__$1["displayName"]);
}
})();
var path = (function (){var G__27716 = elem;
var G__27716__$1 = (((G__27716 == null))?null:(G__27716["_owner"]));
var G__27716__$2 = (((G__27716__$1 == null))?null:reagent$impl$component$component_path.call(null,G__27716__$1));
if((G__27716__$2 == null)){
return null;
} else {
return [cljs.core.str(G__27716__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__25976__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__25976__auto__)){
return or__25976__auto__;
} else {
var G__27718 = c;
var G__27718__$1 = (((G__27718 == null))?null:G__27718.constructor);
if((G__27718__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__27718__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1518788502622