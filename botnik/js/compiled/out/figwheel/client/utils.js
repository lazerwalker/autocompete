...
var or__25976__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj41259 = {"detail":data};
return obj41259;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__25964__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__25964__auto__)){
var and__25964__auto____$1 = (window["CustomEvent"]);
...
var args41264 = [];
var len__27051__auto___41270 = arguments.length;
var i__27052__auto___41271 = (0);
while(true){
if((i__27052__auto___41271 < len__27051__auto___41270)){
args41264.push((arguments[i__27052__auto___41271]));

var G__41272 = (i__27052__auto___41271 + (1));
i__27052__auto___41271 = G__41272;
continue;
} else {
}
break;
...
var f = (function (){var pred__41267 = cljs.core._EQ_;
var expr__41268 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__41267.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__41268))){
return ((function (pred__41267,expr__41268){
return (function (p1__41260_SHARP_){
return console.warn(p1__41260_SHARP_);
});
;})(pred__41267,expr__41268))
} else {
if(cljs.core.truth_(pred__41267.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__41268))){
return ((function (pred__41267,expr__41268){
return (function (p1__41261_SHARP_){
return console.debug(p1__41261_SHARP_);
});
;})(pred__41267,expr__41268))
} else {
if(cljs.core.truth_(pred__41267.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__41268))){
return ((function (pred__41267,expr__41268){
return (function (p1__41262_SHARP_){
return console.error(p1__41262_SHARP_);
});
;})(pred__41267,expr__41268))
} else {
return ((function (pred__41267,expr__41268){
return (function (p1__41263_SHARP_){
return console.log(p1__41263_SHARP_);
});
;})(pred__41267,expr__41268))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__41274){
var map__41277 = p__41274;
var map__41277__$1 = ((((!((map__41277 == null)))?((((map__41277.cljs$lang$protocol_mask$partition0$ & (64))) || (map__41277.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41277):map__41277);
var opts = map__41277__$1;
var eval_fn = cljs.core.get.call(null,map__41277__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__41279_SHARP_){
return new_def.callback(p1__41279_SHARP_);
});})(new_def))
);
...
return (function (p__41280){
var vec__41281 = p__41280;
var ky = cljs.core.nth.call(null,vec__41281,(0),null);
...
var args41284 = [];
var len__27051__auto___41287 = arguments.length;
var i__27052__auto___41288 = (0);
while(true){
if((i__27052__auto___41288 < len__27051__auto___41287)){
args41284.push((arguments[i__27052__auto___41288]));

var G__41289 = (i__27052__auto___41288 + (1));
i__27052__auto___41288 = G__41289;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var and__25964__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1518788567659